...
namespace BluetoothChat
{
	...
	{
		// Debugging
		private const string TAG = "luetoothChat";
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			RequestWindowFeature (WindowFeatures.CustomTitle);    //加了下一句报错
		...
		private class MyHandler : Handler
		{
			...
			public override void HandleMessage (Message msg)
			{
				...
				case MESSAGE_WRITE:
					...
					bluetoothChat.conversationArrayAdapter.Add ("发送：" + writeMessage);
					break;
				case MESSAGE_READ:
